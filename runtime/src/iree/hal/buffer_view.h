...
enum iree_hal_numerical_type_bits_t {
  ...
  // Ad-hoc entries for the zoo of low-bit-depth float types. There currently
  // are 4 8-bit float types that we need to support. For now just create these
  // 4 nameless "slots" to fit those types.
  IREE_HAL_NUMERICAL_TYPE_FLOATISH_0 = IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x04u,
  IREE_HAL_NUMERICAL_TYPE_FLOATISH_1 = IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x05u,
  IREE_HAL_NUMERICAL_TYPE_FLOATISH_2 = IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x06u,
  IREE_HAL_NUMERICAL_TYPE_FLOATISH_3 = IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x07u,
};
...
enum iree_hal_element_types_t {
  ...
  IREE_HAL_ELEMENT_TYPE_FLOAT_8_E5M2       = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOATISH_0,          8),  // NOLINT
  IREE_HAL_ELEMENT_TYPE_FLOAT_8_E4M3       = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOATISH_1,          8),  // NOLINT
  IREE_HAL_ELEMENT_TYPE_FLOAT_8_E5M2_FNUZ  = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOATISH_2,          8),  // NOLINT
  IREE_HAL_ELEMENT_TYPE_FLOAT_8_E4M3_FNUZ  = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOATISH_3,          8),  // NOLINT
};
