func.func @foo(%lhs: tensor<?x?x8x4x16x2x8xf8E4M3FNUZ>, %rhs: tensor<?x?x4x2x4x16x2x8xf8E4M3FNUZ>) -> tensor<?x?x8x4x2x4x16x4xf32> {
  %c0 = arith.constant 0 : index
  %c0_f32 = arith.constant 0.0 : f32
  %m = tensor.dim %lhs, %c0 : tensor<?x?x8x4x16x2x8xf8E4M3FNUZ>
  %n = tensor.dim %rhs, %c0 : tensor<?x?x4x2x4x16x2x8xf8E4M3FNUZ>
  ...
  %result = iree_gpu.multi_mma %lhs, %rhs, %zero {
    indexing_maps = [
      ...
      unroll_k = 2
    >} : tensor<?x?x8x4x16x2x8xf8E4M3FNUZ>, tensor<?x?x4x2x4x16x2x8xf8E4M3FNUZ> into tensor<?x?x8x4x2x4x16x4xf32>
