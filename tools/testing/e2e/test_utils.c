...
iree_test_utils_e2e_value_t iree_test_utils_value_make_f8E5M2(uint16_t value) {
  iree_test_utils_e2e_value_t result;
...
iree_test_utils_e2e_value_t iree_test_utils_value_make_f8E4M3(uint16_t value) {
  iree_test_utils_e2e_value_t result;
